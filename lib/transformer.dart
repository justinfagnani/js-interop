...
import 'src/transformer/interface_transformer.dart';
import 'src/transformer/export_transformer.dart';
 ...
 *   * Export Dart code annotated with @Export
 */
class JsTransformerGroup implements TransformerGroup {
  static final _resolvers = new Resolvers(dartSdkDirectory);

  final Iterable<Iterable> phases = [
    [new InterfaceTransformer(_resolvers)],
    [new ExportTransformer(_resolvers)]
  ];

  JsTransformerGroup.asPlugin(BarbackSettings settings) {
    // TODO: read libraries to be transformed
  }
}
